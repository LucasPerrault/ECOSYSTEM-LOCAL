...
class Module {
  ...
  public static function login() {
    ?>
    <link rel="stylesheet" href="<?=ROOT_URL?>static/css/partage/login/login-desktop.css">
    <link rel="stylesheet" href="<?=ROOT_URL?>static/css/partage/login/login-mobile.css">
    <?php
  }
}
?>
